        ...
        <section className="px-4 md:px-8 py-12 md:py-16" style={{ backgroundColor: "#FECB23" }}>
          <div className="max-w-6xl mx-auto">
            ...
            <div className="flex justify-center mt-8">
              <Link href="/upload">
                <Button
                  className="mobile-button bg-orange-400 hover:bg-orange-500 text-black font-black text-lg md:text-xl px-8 md:px-10 py-3 md:py-4 rounded-full border-2 md:border-4 border-black shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] md:shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:shadow-[1px_1px_0px_0px_rgba(0,0,0,1)] md:hover:shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] transition-all"
                  style={{ backgroundColor: "#FF6B6B" }}
                >
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="relative w-full">
              ...
              <div className="relative flex flex-col md:flex-row">
                <div className="flex-1 flex items-center justify-center z-10 mb-6 md:mb-0">
                  <video
                ...
                <div className="flex-1 flex items-center justify-center md:pl-8 md:-translate-y-10">
                  <div className="mobile-card bg-white rounded-2xl md:rounded-3xl border-4 md:border-8 border-black p-6 md:p-8 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] md:shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] w-full">
                    <h3 className="text-xl md:text-2xl font-black text-black mb-2">💛 Say it with a flipbook</h3>
                    <p className="text-base md:text-lg text-gray-700">More than words—show the moment that says it all.</p>
                  </div>
                </div>
              </div>
              {/* Bottom row: text left (offset up), image right (offset down) */}
              <div className="relative flex flex-col md:flex-row mt-6 md:-mt-16">
                <div className="flex-1 flex items-center justify-center md:pr-8 md:translate-y-10 order-2 md:order-1 mb-6 md:mb-0">
                  <div className="mobile-card bg-white rounded-2xl md:rounded-3xl border-4 md:border-8 border-black p-6 md:p-8 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] md:shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] w-full">
        ...
        <section className="px-4 md:px-8 py-12 md:py-16" style={{ backgroundColor: "#FECB23" }}>
          <div className="max-w-6xl mx-auto">
            ...
            <div className="flex justify-center">
              <div className="mobile-card bg-white rounded-2xl md:rounded-3xl border-4 md:border-8 border-black p-6 md:p-8 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] md:shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] max-w-6xl w-full">
